              ...
              <hr/>
                <div className="row">
                  ...
                  <div className="col-md-9">
                    ...
                    <p className="card-text">During my time working in startups, I worked closely with web developers and project managers. This is when I started to become interested with app and web development. I decided to start my journey and began to learn different programming languages to become a developer. As I continue to learn, I become more excited with this field. I am always eager to learn new skills in order to reach my career goal and create useful websites and applications that help people with their everyday lives.</p>
                    <p className="card-text">I know this journey to be a developer can be difficult. I started a YouTube channel that consist of short coding videos to help others with their own coding journey. The link to that channel can be found on the contact page. </p>
                  </div>
                </div>
            </div>
          </div>
