              ...
              <hr/>
                <div className="row">
                  ...
                  <div className="col-md-9">
                    ...
                    <p className="card-text">I know this journey to be a developer can be difficult. I started a YouTube channel that consist of short coding videos to help others with their coding journey. The link to that channel can be found on the contact page. </p>
                  </div>
                </div>
            </div>
          </div>
